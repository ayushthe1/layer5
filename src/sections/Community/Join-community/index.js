    ...
    <JoinCommunityWrapper image={props.image}>
      <div className="join-community">
        <div className="join-community_text-and_button">
          ...
          {props.btn_primary ? <Button aria-label="join us" primary title="Join Our Talented Community" url="http://slack.layer5.io/" external={true}/>
            : <Button aria-label="join us" secondary title="Join Our Talented Community" url="http://slack.layer5.io/" external={true} />}
        </div>
      </div>

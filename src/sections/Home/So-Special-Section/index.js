  ...
  return (
    <SoSpecialWrapper>
        ...
        <Slider {...settings}>
          {
            data.allMdx.nodes.map(({ id, frontmatter, fields }) => (
              <Button aria-label="cont_btn" className="special-cont_btn" url={fields.slug} key={id}>
                <div id="special-cont" >
      ...
      <div className="so-special-foot">
        ...
        <Button className="so-special-foot-btn" primary url="/projects" aria-label="our projects" title="Our Projects" />
      </div>
    </SoSpecialWrapper>
  );
};

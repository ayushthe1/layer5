      ...
      <Container>
        ...
        <Row Vcenter >
          ...
          <Col xs={12} sm={6} lg={6}>
            ...
            <Button aria-label="read book" className="book_btn" primary url="/learn/service-mesh-books/the-enterprise-path-to-service-mesh-architectures-2nd-edition" title="Read Book">

          ...
          <Col sm={8} lg={8} className="section-title-wrapper">
            ...
            <span className="vintage-box-container">
              <VintageBox right={true} vintageOne={true}>
                <Button primary aria-label="join-the-community" className="banner-btn one" title="Join in" url="/community">
                  <FaMapMarkedAlt size={21} className="icon-left" />
                </Button>
                <Button primary className="banner-btn two" title="See Meshery" aria-label="go-to-meshery" url="/cloud-native-management/meshery">

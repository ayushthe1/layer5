      ...
      <Container>
        ...
        <div className="service-mesh-patterns">
          <div className="service-mesh-patterns_text-and_button">
            ...
            <Button aria-label="visit smp" secondary title="Visit Service Mesh Patterns website" url="https://service-mesh-patterns.github.io/service-mesh-patterns/" external="true" />
          </div>
        </div>
        <JoinCommunity
          image={Book_Giveaway}

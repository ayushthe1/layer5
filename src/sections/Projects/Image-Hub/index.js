        ...
        <Container>
          ...
          <div className="contributors">
            ...
            <VintageBox right={true} vintageOne={true}>
              <Button aria-label="partners" primary title="Layer5 and HashiCorp" url="/partners"></Button>
              &nbsp;
              <Button aria-label="partners" secondary title="Discuss WASM Filters" url="https://discuss.layer5.io/c/webassembly-filters/11" external={true}></Button>
            </VintageBox>

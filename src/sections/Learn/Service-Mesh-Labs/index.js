      ...
      <div className="Labs-section-wrapper">
        ...
        <div className="join-community">
          <div className="join-community_text-and_button">
            ...
            <Button aria-label="smp website" primary title="Visit Service Mesh Patterns website" url="https://service-mesh-patterns.github.io/service-mesh-patterns/" external="true" />
          </div>
        </div>
      </div>
    </LabsWrapper>

    ...
    <LabSinglePageWrapper>
      ...
      <div className="join-community">
        <div className="join-community_text-and_button">
          ...
          <Button aria-label="go to service mesh pattern" primary title="Visit Service Mesh Patterns website" url="https://service-mesh-patterns.github.io/service-mesh-patterns/" external="true" />
        </div>
      </div>
    </LabSinglePageWrapper>
  );

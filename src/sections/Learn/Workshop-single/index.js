    ...
    <WorkshopSinglePageWrapper>
      ...
      <Container>
        ...
        <div className="bottomBtn">
          <Button aria-label="workshop" secondary title="Request a Workshop" url="mailto:training@layer5.io" external={true}/>
          <Button aria-label="join workshop" primary title="Join this Workshop" url={frontmatter.eurl}/>
        </div>
      </Container>
    </WorkshopSinglePageWrapper>
  );

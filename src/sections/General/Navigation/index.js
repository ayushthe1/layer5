      ...
      <NavigationWrap className={`nav-block ${scroll ? "scrolled" : ""}`}>
        <Container className="nav-container">
          ...
          <div className="meshery-cta">
            <Button id="get-started-with-us" secondary className="banner-btn two" title="Get Started" aria-label="signup for layer5" alt="Signup for Layer5 Cloud"  url="https://meshery.layer5.io/registration" />

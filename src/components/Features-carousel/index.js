...
const Feature = ({ children, title, active, onClick, learnMoreLink, id, Element = "li" }) => {
  return (
    <Element className={active ? "feature active-feature" : "feature"}>
      ...
      <div className="body" id={`feature-${id}`} aria-hidden="true" tabIndex={-1}>
        <p aria-hidden="true" tabIndex={-1}>{children}</p>
        {learnMoreLink && (
          <Link aria-hidden="true" tabIndex={-1} className="learn-more-link" to={learnMoreLink}>

...
const ContactFormModal = (props) => {
  ...
  return (
    <ContactFormModalWrapper>
      <Button primary className="open-modal-btn" onClick={openModal} title={props.callout_text} aria-label={props.callout_text} />
      <Modal
        isOpen={modalIsOpen}
      ...
      >
        <Button secondary className="close-modal-btn" onClick={closeModal} aria-label="contact form"> <GrFormClose /></Button>
